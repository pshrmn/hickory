...
build(
  'UMD file',
  'rollup -c -f iife -o dist/hickory-browser.js',
  {
    NODE_ENV: 'development',
    BABEL_ENV: 'build'
  }
...
build(
  'UMD min file',
  'rollup -c -f iife -o dist/hickory-browser.min.js',
  {
    NODE_ENV: 'production',
    BABEL_ENV: 'build'
  }
...
const size = fs.statSync('./dist/hickory-browser.js').size;
const minSize = gzipSize.sync(
  fs.readFileSync('./dist/hickory-browser.min.js')
);
